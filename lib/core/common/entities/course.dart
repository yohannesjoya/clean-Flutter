...
class CourseListResponseEntity {
  ...
  factory CourseListResponseEntity.fromJson(DataMap json) =>
      CourseListResponseEntity(
        code: json["code"],
        msg: json["msg"],
...
class CourseDetailResponseEntity {
  ...
  factory CourseDetailResponseEntity.fromJson(DataMap json) =>
      CourseDetailResponseEntity(
        code: json["code"],
        msg: json["msg"],
...
class AuthorResponseEntity {
  ...
  factory AuthorResponseEntity.fromJson(DataMap json) =>
      AuthorResponseEntity(
        code: json["code"],
        msg: json["msg"],
...
class AuthorItem {
  ...
  factory AuthorItem.fromJson(DataMap json) =>
      AuthorItem(
        token: json["token"],
        name: json["name"],
...
class CourseItem {
  ...
  factory CourseItem.fromJson(DataMap json) =>
      CourseItem(
